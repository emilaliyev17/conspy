...
urlpatterns = [
    ...
    path('reports/export/stakeholders/', views.export_for_stakeholders, name='export_for_stakeholders'),
    ...
    path('reports/pl/comments/files/upload/', views.pl_comment_file_upload, name='pl_comment_file_upload'),
    path('reports/pl/comments/files/<int:file_id>/', views.pl_comment_file_delete, name='pl_comment_file_delete'),
